...
<head>
     ...
     <title>Quitanda Online :: Confirmar-Cadastro </title>
...
<body style="min-width:372px;">
     ...
     <main>
          <div class="container">
               ...
               <hr>
               <p class="mt-3">
                    caro <strong>Primeiro Nome de Cliente</strong>
               </p>
               <p class="mt-3">
                    Obrigado por se cadastrar em nossa loja virtual. Um e-mail de confirmação foi enviado
                    para <b>email@dominio.com.br</b>.Clique no link de caonfiemação presente no
