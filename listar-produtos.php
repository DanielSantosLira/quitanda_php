                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="excluir-produtos.php?id=<?php echo $um_produtos["id"]; ?>" class=" btn text-danger">
                                    ...
                                    <td>
                                        <a href="ver-produtos.php?id=<?php echo $um_produtos["id"]; ?>" class=" btn text-success">
                                    ...
                                    <td>
                                        <a href="editar-produtos.php?id=<?php echo $um_produtos["id"]; ?>" class=" btn text-warning">
