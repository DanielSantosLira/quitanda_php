          ...
          <div class="container">
               <div class="row justify-content-center">
                    <form class="col-sm-10 col-md-8 col-lg-6">
                         <h1 class="mb-3 ">Faça seu Login</h1>
                         ...
                         <div class="form-floating mb-3">
                              ...
                              <input type="password" class="form-control" autofocus id="textSenha" placeholder=" ">
                              <label for="textSenha">Senha</label>
                         </div>

                         <div class="form-check mb-3">
                              <input type="checkbox" class="form-check-input" value="" id="textLembrar" placeholder=" ">
                              <label for="chkLembrar" class="form-check-label">Lambra de mim</label>
                         </div>


                         <button class="btn btn-lg btn-danger" type="button">Enviar</button>
                         ...
                         <p class="mt-3">
                              Esqueceu sua senha? <a href="recuperar-senha.php">Clique aqui</a> para
                              recuperá-la
                         </p>
                    </form>
               </div>
