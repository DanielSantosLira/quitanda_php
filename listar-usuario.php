                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="editar-usuario.php?id=<?php echo $um_usuario["id"]; ?>" class="btn  text-danger">
                                    ...
                                    <td>
                                        <a href="excluir-usuario.php?id=<?php echo $um_usuario["id"]; ?>" class=" btn bg-danger text-white">
