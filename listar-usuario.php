                    ...
                    <table class="table  table-hover-warning tabla-striped ">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="ver-usuario.php?id=<?php echo $um_usuario["id"]; ?>" class="btn btn-light btn-outline-primary">
                                ...
                                <td>
                                    <a href="editar-usuario.php?id=<?php echo $um_usuario["id"]; ?>" class="btn btn-light btn-outline-primary">
