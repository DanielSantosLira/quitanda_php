            ...
            <div class="row justify-content-center">
                <form class="col-sm-10 col-md-8 col-lg-6">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" autofocus id="textNome" placeholder=" ">
                        <label for="textNome">Nome Completo</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="email" class="form-control" autofocus id="textEmail" placeholder=" ">
                        <label for="textEmail">
                    ...
                    <div class="form-floating mb-3">
                        <textarea class="form-control" id="textMeansagem" placeholder=" " style="height: 200px;"></textarea>

                        <label for="textMensagem">
                    ...
                    <button class="btn btn-lg btn-danger" type="button" onclick="window.location.href='confirmar-contato.php'">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope" viewBox="0 0 16 16" id="textMensagem">
                            <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4Zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1H2Zm13 2.383-4.708 2.825L15 11.105V5.383Zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741ZM1 11.105l4.708-2.897L1 5.383v5.722Z" />
